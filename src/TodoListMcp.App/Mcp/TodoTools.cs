...
public sealed class TodoTools
{
    ...
    public TodoTask AddTask(
        ...
        [Description("File/URL links to attach (local/network paths, http(s)/mailto URLs, or tdl:// task links). Stored verbatim; exact duplicates are collapsed case-insensitively, as ToDoList does.")] string[]? fileLinks = null,
        [Description("Alias of the configured list. Omit to use the default list.")] string? list = null) =>
    ...
    public TodoTask UpdateTask(
        ...
        [Description("Replace the file/URL links (empty array clears them). Stored verbatim; exact duplicates are collapsed case-insensitively, as ToDoList does.")] string[]? fileLinks = null,
        [Description("Alias of the configured list. Omit to use the default list.")] string? list = null) =>
